...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyramids-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyramids-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `pyramids` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
conda install pyramids pyramids-lazy pyramids-parquet pyramids-stac pyramids-viz
```
...
```
mamba install pyramids pyramids-lazy pyramids-parquet pyramids-stac pyramids-viz
```
...
pixi add pyramids pyramids-lazy pyramids-parquet pyramids-stac pyramids-viz
# for installing globally
pixi global install pyramids pyramids-lazy pyramids-parquet pyramids-stac pyramids-viz
```
...
It is possible to list all of the versions of `pyramids` available on your platform:
...
```
mamba search pyramids --channel conda-forge
```
...
```
pixi search pyramids --channel conda-forge
```
...
mamba repoquery search pyramids --channel conda-forge

# List packages depending on `pyramids`:
mamba repoquery whoneeds pyramids --channel conda-forge

# List dependencies of `pyramids`:
mamba repoquery depends pyramids --channel conda-forge
```
...
Updating pyramids-feedstock
===========================

If you would like to improve the pyramids recipe or build a new
...
Note that all branches in the conda-forge/pyramids-feedstock are
